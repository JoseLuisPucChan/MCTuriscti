                            ...
                            <div class="col-lg-6">
                                <div class="form-group border-blue">
                                    ...
                                    <div class="input-prepend input-group">
                                       <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtFecha" Format="dd-MM-yyyy" />
                    ...
                    <div class="divider"></div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group border-blue">
                                    ...
                                    <h3><i class="glyph-icon icon-calendar"></i>Fecha de nacimiento</h3>
                                    <div class="input-prepend input-group">
                                         <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtFechaNEdit" Format="dd-MM-yyyy" />
