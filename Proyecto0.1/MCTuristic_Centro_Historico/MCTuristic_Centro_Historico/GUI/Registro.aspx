                            ...
                            <form method="post" action="#">
                                <ul>
                                    <li>
                                        ...
                                        <asp:TextBox ID="txtTelefono" type="text" placeholder="Número teléfono" runat="server" required pattern=".*\S.*"></asp:TextBox>
                                    </li>
                                </ul>
                                <ul class="row">
                                    <li class="col-lg-6">
                                ...
                                <ul class="row">
                                    ...
                                    <li class="col-lg-3">
                                        ...
                                        <asp:TextBox ID="txtContraseña" type="text" placeholder="******" runat="server" BorderStyle="Double" CssClass="text" Height="46px" TextMode="Password" Width="199px" required pattern=".*\S.*"></asp:TextBox>

                                    </li>
                                    <li class="col-lg-3">
                                        <label><font><font>Confirmar contraseña*</font></font></label>
                                        <asp:TextBox ID="txtConfirmarContraseña" type="text" placeholder="******" runat="server" BorderStyle="Double" CssClass="text" Height="46px" TextMode="Password" Width="199px" required pattern=".*\S.*"></asp:TextBox>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
              ...
              if (input.files && input.files[0]) {
                  ...
                  reader.readAsDataURL(input.files[0]);
                                    ...
                                    <li>
                                        ...
                                        <asp:TextBox ID="Calender" runat="server" required pattern=".*\S.*"></asp:TextBox>
                                    </li>
                                </ul>
                        </div>
                    </div>
